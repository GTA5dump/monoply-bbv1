...
namespace monopoly::features
{
	/*inline int OpenKey_gamepad = XINPUT_GAMEPAD_DPAD_LEFT;*/
	...
	extern bool therealflashrun;
	void Therealflashrun(bool toggle);
	...
	//extern bool money500k;
	//void Money500k(bool toggle);
	void addMoney();
	void Wheelcooldown();
	void cayoSkipPreps();
	void swordKnife();
	...
	extern bool givehornboost;
	void Givehornboost(bool toggle);
